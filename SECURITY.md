...
Security-sensitive areas include adapter trust, arbitrary task execution, resource deletion and GC, process-group signaling, symlink traversal, repository-local configuration trust, and service-definition transaction recovery (launchd and systemd). Never include real credentials or private user data in a report.
