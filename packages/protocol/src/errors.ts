...
export const wtmErrorCodeSchema = z.enum([
  'WTM_NOT_INITIALIZED', 'WTM_WORKSPACE_NOT_FOUND', 'WTM_CONFIG_INVALID', 'WTM_TEMPLATE_UNRESOLVED', 'WTM_DAEMON_UNAVAILABLE', 'WTM_DAEMON_INVALID_REQUEST', 'WTM_DAEMON_PROTOCOL_INCOMPATIBLE', 'WTM_DAEMON_REQUEST_FAILED', 'WTM_OPERATION_CONFLICT', 'WTM_SOCKET_PATH_TOO_LONG',
