...
export const wtmErrorCodeSchema = z.enum([
  'WTM_NOT_INITIALIZED', 'WTM_WORKSPACE_NOT_FOUND', 'WTM_CONFIG_INVALID', 'WTM_TEMPLATE_UNRESOLVED', 'WTM_DAEMON_UNAVAILABLE', 'WTM_DAEMON_INVALID_REQUEST', 'WTM_DAEMON_PROTOCOL_INCOMPATIBLE', 'WTM_DAEMON_REQUEST_FAILED', 'WTM_OPERATION_CONFLICT', 'WTM_SOCKET_PATH_TOO_LONG', 'WTM_PLATFORM_UNSUPPORTED', 'WTM_WATCH_UNAVAILABLE', 'WTM_WORKTREE_PATH_OCCUPIED',
  'GIT_COMMAND_FAILED', 'GIT_REPOSITORY_DEGRADED', 'GIT_MAIN_WORKTREE', 'GIT_WORKTREE_LOCKED', 'GIT_DIRTY_STAGED', 'GIT_DIRTY_UNSTAGED', 'GIT_UNTRACKED', 'GIT_UNMERGED', 'GIT_HEAD_NOT_REMOTE_PERSISTED', 'GIT_UPSTREAM_MISSING', 'GIT_BRANCH_IN_USE',
