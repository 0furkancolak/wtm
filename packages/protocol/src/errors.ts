...
export const wtmErrorCodeSchema = z.enum([
  ...
  'WTM_NOT_INITIALIZED', 'WTM_WORKSPACE_NOT_FOUND', 'WTM_CONFIG_INVALID', 'WTM_TEMPLATE_UNRESOLVED', 'WTM_DAEMON_UNAVAILABLE', 'WTM_DAEMON_INVALID_REQUEST', 'WTM_DAEMON_PROTOCOL_INCOMPATIBLE', 'WTM_DAEMON_REQUEST_FAILED', 'WTM_DAEMON_TIMEOUT', 'WTM_OPERATION_CONFLICT', 'WTM_SOCKET_PATH_TOO_LONG', 'WTM_IPC_PATH_UNUSABLE', 'WTM_PRIVATE_DIRECTORY_UNSAFE', 'WTM_PLATFORM_UNSUPPORTED', 'WTM_WATCH_UNAVAILABLE', 'WTM_CI_UNAVAILABLE', 'WTM_WORKTREE_PATH_OCCUPIED',
  ...
  'RUNTIME_PORT_UNAVAILABLE', 'RUNTIME_TASK_ALREADY_RUNNING', 'RUNTIME_TASK_NOT_RUNNING', 'RUNTIME_PROCESS_IDENTITY_STALE', 'RUNTIME_START_FAILED', 'RUNTIME_STOP_FAILED', 'RUNTIME_PROCESS_BUDGET_EXCEEDED', 'RUNTIME_MEMORY_BUDGET_EXCEEDED',
