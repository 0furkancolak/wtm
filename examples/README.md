...
- [`bun-monorepo/wtm.toml`](bun-monorepo/wtm.toml) uses Bun, a worktree-local web app, stable dynamic ports, and an exposed development task. Its `apps/web` directory must exist.
